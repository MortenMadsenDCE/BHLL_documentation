...
j.  Registry data prepared for easy access (restricted to BHLL+background population) for programmers doing their own data-extraction for the BHLL-cohort. [BHLL Pre‑Filtered Extraction Datasets](extraction_datasets.html)
...
d.  Kristensen FPB et al. [Helbredstilstanden blandt borgere i alderen 50-65 år i Region Midtjylland. Rapport 1: Livsstil og selvrapporteret helbred](https://kea.au.dk/fileadmin/KEA/filer/Other_reports/Helbredstilstanden_blandt_borgere_i_Region_Midtjylland_til_www.pdf)
