...
2.  List of relevant variables that have been calculated or cleaned up before and are therefore might be relevant to reuse in future studies:
    ...
    b.  Dietary score (Julie) –\>(Spring2025: Julie and Morten has been working on implementing [a dietary score for nutrition among cancer patients](Dietary_Score.hmtl). Maybe possible to reuse in other projects)
