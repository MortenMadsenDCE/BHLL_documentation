...
2.  List of relevant variables that have been calculated or cleaned up before and are therefore might be relevant to reuse in future studies:
    ...
    i.  Some diseases are complicated to identify well using registries. Find here description of algorithm and path for a dataset with the values: [CKD](CKD.html), (diabetes?).
