...
2.  List of relevant variables that have been calculated or cleaned up before and are therefore might be relevant to reuse in future studies:
    ...
    b.  SEP-variables (Cathrine and Morten) –\> (April 2025: Morten and Cathrine are working on a set of recommended, well defined and easy accessible SEP-variables that can easily be included in your study)
