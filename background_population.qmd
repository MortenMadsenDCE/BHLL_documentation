...
The background population cohort (DK50_65) is selected on similar criteria as BHLL-cohort:
...
-   **BHLL**: 1 for BHLL-respodndents, 0 for background population. (Unfortunately it is not possible to identify those invited to the questionnaire, who didn't respond).
